...
KK2_OBJ_BEGIN(kk2_string)
    ...
    KK2_OBJ_UNION_BEGIN()
        KK2_OBJ_ARRAY(builtin, kk2_string_char_t, KK2_STRING_BUILTIN)
        KK2_OBJ_FIELD(chars, kk2_string_char_pt)
    KK2_OBJ_UNION_END()
KK2_OBJ_END(kk2_string)

typedef char* kk2_cstring_t;
typedef wchar_t* kk2_wstring_t;
...
extern kk2_string_char_pt kk2_string_chars(
    kk2_string_cpt self
);
...
extern kk2_range_index_t kk2_string_range(
    kk2_string_cpt self
);

extern kk2_index_t kk2_string_start_index(
    kk2_string_cpt self
);

extern kk2_index_t kk2_string_end_index(
    kk2_string_cpt self
);
