...
#define KK2_TYPEDEF(RAW, NAME) typedef RAW NAME##_t; typedef const NAME##_t NAME##_ct; typedef NAME##_t* NAME##_pt; typedef NAME##_ct* NAME##_cpt;

KK2_TYPEDEF(bool, kk2_bool);

KK2_TYPEDEF(void*, kk2_pointer);
...
#define KK2_OBJ_UNION_BEGIN(NAME) union NAME {
